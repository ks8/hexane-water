"Script to build a full read_data LAMMPS file from two sets of molecular data files, by Kirk Swanson"
...
def process_datafile(files):
	...
	num_atoms_original_type2 = contents2[2].split()
	num_bonds_original_type2 = contents2[3].split()
	num_angles_original_type2 = contents2[4].split()
	num_dihedrals_original_type2 = contents2[5].split()

	num_atomtype_original_type2 = contents1[7].split()
	num_bondtype_original_type2 = contents1[8].split()
	num_angletype_original_type2 = contents1[9].split()
	num_dihedraltype_original_type2 = contents1[10].split()
	...
	num_molecules_type1 = 125
	num_molecules_type2 = 125
	...
	out.write('\n')
	out.write('-5.000000 70.000000 xlo xhi\n')
	out.write('-5.000000 70.000000 ylo yhi\n')
	out.write('-5.000000 70.000000 zlo zhi\n')
	out.write('\n')
