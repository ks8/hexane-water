"DASH python script for simulations of Webb hexane, by Kirk Swanson"
import sys
import numpy as np
...
# Write configuration and restart files 
...
reader.read(dataFn = 'input.txt', inputFns = ['hexane.in.settings'])

# Record and initialize temperature
