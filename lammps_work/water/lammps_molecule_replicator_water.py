"Script to build a full read_data LAMMPS file from one molecular data file for water, by Kirk Swanson"
...
def process_datafile(files):
	...
	num_atomtype_original_type1 = contents1[6].split()
	num_bondtype_original_type1 = contents1[7].split()
	num_angletype_original_type1 = contents1[8].split()
