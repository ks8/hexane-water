"Script to build a full read_data LAMMPS file from two sets of molecular data files, but for just a single molecule, set num_molecules_type2=0 and use the same datafile for both inputs, by Kirk Swanson"
...
def process_datafile(files):
	...
	num_molecules_type1 = 500
	num_molecules_type2 = 0
